...
async function run() {
  ...
  try {
    ...
    await page.screenshot({ path: `${ARTIFACT_DIR}/local_login_page.png` });
    ...
    await page.screenshot({ path: `${ARTIFACT_DIR}/local_dashboard_page.png` });
    console.log('Saved dashboard page screenshot.');
    ...
    await page.screenshot({ path: `${ARTIFACT_DIR}/local_new_tournament_page_1.png` });
    console.log('Saved page step 1 screenshot.');

    // 4. Fill basic information
    const uniqueName = `Local Test ${Date.now()}`;
    ...
    await page.screenshot({ path: `${ARTIFACT_DIR}/local_new_tournament_page_filled.png` });
    ...
    await page.screenshot({ path: `${ARTIFACT_DIR}/local_final_page.png` });
