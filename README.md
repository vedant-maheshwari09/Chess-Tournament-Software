...
- **Friendly Case-Insensitive Slug Routing**: Easily share clean, customized links like `/tournament/Spring-Open-2026` rather than numeric IDs. A global `TournamentSlugResolver` interceptor seamlessly maps case-insensitive name slugs on the client and redirects to standard numeric routes.
