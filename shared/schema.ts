...
export const players = pgTable("players", {
  ...
  uscfRatingRaw: text("uscf_rating_raw"),
  fideRatingRaw: text("fide_rating_raw"),
...
export const playerRegistrations = pgTable("player_registrations", {
  ...
  uscfRating: integer("uscf_rating"),
  fideRating: integer("fide_rating"),
  uscfRatingRaw: varchar("uscf_rating_raw", { length: 30 }),
  fideRatingRaw: varchar("fide_rating_raw", { length: 30 }),
...
export const uscfVerificationAttempts = pgTable("uscf_verification_attempts", {
  ...
  startedOffProfile: boolean("started_off_profile"),
  navigatedToProfile: boolean("navigated_to_profile"),
